...
<div id="navigation">
    <ul>
     <li><a href="AccountStatement.jsp">A/c Statement</a></li>
    <li><a href="TransferCustomer.html">Transfer Amount</a></li>
    <li><a href="CalcBill.html">Pay Bills</a></li>
    <li><a href="Recharge.html">Recharge</a></li>
     <li><a href="AccountInfo.jsp">A/c Info</a></li>
      <li><a href="ChangePassword.html">Change Pswd</a></li>
